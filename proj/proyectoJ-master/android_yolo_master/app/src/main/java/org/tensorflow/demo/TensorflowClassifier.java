...
class TensorFlowClassifier implements Classifier {
  ...
  private final String[] class_labels =  {"Avion", "Bicicleta", "Pajaro", "Barco", "Botella", "Autobus", "Automovil",
          "Gato", "Silla", "Vaca", "Comedor", "Perro", "Caballo", "Motocicleta", "Persona",
          "Planta en Maceta", "Oveja", "sofa", "Tren","Monitor"};
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    Log.i("AQUI",class_labels[predicted_class]+" Probabilidad: "+(highest_prob*100)+"%");
    CameraActivity.Objeto=class_labels[predicted_class];
    CameraActivity.ObjetoProb=(highest_prob*100);
    Trace.endSection();
    return recognitions;
  }
